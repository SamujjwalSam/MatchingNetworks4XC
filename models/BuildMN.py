...
class BuildMN:
    ...
    def __init__(self, data, num_categories=0, optim="adam", lr=1e-03, decay=1e-6, dropout=0.2, use_cuda=False):
        """
    ...
    def build_experiment(self, classes_per_set, samples_per_class, channels, fce=True, batch_size=64):
        """
        ...
        self.matchingNet = MatchingNetwork(batch_size=batch_size,
                                           dropout=self.keep_prob, num_channels=channels,
                                           fce=fce,
                                           num_classes_per_set=classes_per_set,
                                           num_samples_per_class=samples_per_class,
                                           num_categories=0, input_size=28)
        print("Matching Network Summary: {}".format(self.matchingNet))
        self.optimizer = 'adam'
        self.lr = 1e-03
